...
PageContent.create(title: "Título Bienvenida", html: '<h1 class="uppercase strong">Bienvenido a<br><span class="accent-color">Poblautos</span></h1>
<p class="lead">Nos dedicamos a la compra y venta de <br>vehículos nuevos y usados de <span class="accent-color">Alta Gama</span></p>', page: "Inicio")
